...
export default function ArchieveComp() {
    ...
    return <div className='archieve'>
      ...
      <TabContext value={value}>
        ...
        <TabPanel style={{display: "flex", position: "absolute", top: "100px"}} value="1">
            ...
            <div className='journal-image'>
                <Link><img src={assets.archieve1} alt="Journal image" /></Link>
            </div>
            <div className='journal-image'>
                <Link><img src={assets.archieve1} alt="Journal image" /></Link>
            </div>
